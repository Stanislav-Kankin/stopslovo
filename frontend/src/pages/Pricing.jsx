const plans = [
  {
    ...
    name: "Фрилансер",
    price: "1 990 ₽/мес",
    features: ["До 3 клиентов", "До 5 000 объявлений/мес", "Полный отчёт", "Экспорт XLSX / CSV"]
  },
  {
    id: "agency_s",
    name: "Агентство S",
    price: "5 990 ₽/мес",
    features: ["До 20 клиентов", "До 50 000 объявлений/мес", "Полный отчёт", "Экспорт XLSX / CSV"]
  },
  {
    id: "agency_m",
    name: "Агентство M",
    price: "12 990 ₽/мес",
    features: ["Без лимита объявлений", "Без лимита клиентов", "Полный отчёт", "Экспорт XLSX / CSV"]
  },
  {
    id: "one_time",
